...
VIT_tuning_MNIST:
	python3 -m experiments.tuning.main --MODEL_NAME VIT --DATASET_NAME MNIST
all_tuning_MNIST: FNN_tuning_MNIST AlexNet_tuning_MNIST VIT_tuning_MNIST
...
VIT_training_MNIST:
	python3 -m experiments.training.main --MODEL_NAME VIT --DATASET_NAME MNIST --READ_HP 
all_training_MNIST: FNN_training_MNIST AlexNet_training_MNIST VIT_training_MNIST
...
VIT_tuning_CIFAR100:
	python3 -m experiments.tuning.main --MODEL_NAME VIT --DATASET_NAME CIFAR100
all_tuning_CIFAR100: FNN_tuning_CIFAR100 AlexNet_tuning_CIFAR100 VIT_tuning_CIFAR100
...
VIT_training_CIFAR100:
	python3 -m experiments.training.main --MODEL_NAME VIT --DATASET_NAME CIFAR100 --READ_HP
all_training_CIFAR100: FNN_training_CIFAR100 AlexNet_training_CIFAR100 VIT_training_CIFAR100

tune_and_train_all_CIFAR100: all_tuning_CIFAR100 all_training_CIFAR100

train_explore_MLflow: 
	python3 -m experiments.train_explore.main --MODEL_NAME VIT --DATASET_NAME CIFAR100
